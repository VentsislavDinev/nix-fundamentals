...
# This command is used to convert a Git object name (like 231ab18) into a form that is readable and usable by other Git commands.
  getCommitHash = { 
    commit_one_hash = "$(git rev-parse $(commit_one))"; #231ab1829e9ef2433629e2b7c565370f63b4401b
    commit_two_hash = "$(git rev-parse $(commit_two))"; #73616ab9dfb1773d816ee53004f56795f87728e3
    commit_three_hash = "$(git rev-parse $(commit_three))"; #897ad292078780ef406a161d7925d0b0b9da126a
    commit_four_hash = "$(git rev-parse $(commit_four))"; #9db665144c2aa5313bd3f31e7596c77011645881
  };
